...
BOOST_AUTO_TEST_CASE(sum)
{
	...
	BOOST_CHECK_EQUAL(mv00.at<0>(), 5.0);
	...
	BOOST_CHECK_EQUAL(mv06.at<0>(), 111.0);
	...
	BOOST_CHECK_EQUAL(mv11.at<1>(), 16.0);
	BOOST_CHECK_EQUAL(mv11.at<2>(), 20.0);
	...
	BOOST_CHECK_EQUAL(mv13.at<1>(), 46.0);
	BOOST_CHECK_EQUAL(mv13.at<2>(), 50.0);
	...
	BOOST_CHECK_EQUAL(mv15.at<1>(), 84.0);
	BOOST_CHECK_EQUAL(mv15.at<2>(), 90.0);
	BOOST_CHECK_EQUAL(mv15.at<3>(), 89.0);

	mv2<0,1,2,3> mv16 = std::get<1>(lhs) + std::get<6>(rhs);

	BOOST_CHECK_EQUAL(mv16.at<0>(), 109.0);
	BOOST_CHECK_EQUAL(mv16.at<1>(), 118.0);
	BOOST_CHECK_EQUAL(mv16.at<2>(), 134.0);
	...
	BOOST_CHECK_EQUAL(mv22.at<3>(), 36.0);
	...
	BOOST_CHECK_EQUAL(mv26.at<3>(), 148.0);

	mv2<0,1,2> mv30 = std::get<3>(lhs) + std::get<0>(rhs);

	BOOST_CHECK_EQUAL(mv30.at<0>(), 26.0);
	...
	BOOST_CHECK_EQUAL(mv31.at<1>(), 40.0);
	BOOST_CHECK_EQUAL(mv31.at<2>(), 44.0);
	...
	BOOST_CHECK_EQUAL(mv33.at<0>(), 60.0);
	BOOST_CHECK_EQUAL(mv33.at<1>(), 70.0);
	BOOST_CHECK_EQUAL(mv33.at<2>(), 74.0);

	mv2<0,1,2,3> mv34 = std::get<3>(lhs) + std::get<4>(rhs);

	BOOST_CHECK_EQUAL(mv34.at<0>(), 82.0);
	...
	BOOST_CHECK_EQUAL(mv35.at<1>(), 108.0);
	BOOST_CHECK_EQUAL(mv35.at<2>(), 114.0);
	BOOST_CHECK_EQUAL(mv35.at<3>(), 89.0);

	mv2<0,1,2,3> mv36 = std::get<3>(lhs) + std::get<6>(rhs);

	BOOST_CHECK_EQUAL(mv36.at<0>(), 132.0);
	BOOST_CHECK_EQUAL(mv36.at<1>(), 142.0);
	BOOST_CHECK_EQUAL(mv36.at<2>(), 158.0);
	BOOST_CHECK_EQUAL(mv36.at<3>(), 131.0);

	mv2<0,3> mv40 = std::get<4>(lhs) + std::get<0>(rhs);

	BOOST_CHECK_EQUAL(mv40.at<0>(), 50.0);
	...
	BOOST_CHECK_EQUAL(mv42.at<3>(), 72.0);

	mv2<0,1,2,3> mv43 = std::get<4>(lhs) + std::get<3>(rhs);

	BOOST_CHECK_EQUAL(mv43.at<0>(), 84.0);
	...
	BOOST_CHECK_EQUAL(mv44.at<0>(), 106.0);
	BOOST_CHECK_EQUAL(mv44.at<3>(), 114.0);
	...
	BOOST_CHECK_EQUAL(mv51.at<1>(), 78.0);
	BOOST_CHECK_EQUAL(mv51.at<2>(), 84.0);
	...
	BOOST_CHECK_EQUAL(mv52.at<3>(), 92.0);

	mv2<0,1,2,3> mv53 = std::get<5>(lhs) + std::get<3>(rhs);

	BOOST_CHECK_EQUAL(mv53.at<0>(), 37.0);
	BOOST_CHECK_EQUAL(mv53.at<1>(), 108.0);
	BOOST_CHECK_EQUAL(mv53.at<2>(), 114.0);
	...
	BOOST_CHECK_EQUAL(mv54.at<3>(), 134.0);

	mv2<1,2,3> mv55 = std::get<5>(lhs) + std::get<5>(rhs);

	BOOST_CHECK_EQUAL(mv55.at<1>(), 146.0);
	BOOST_CHECK_EQUAL(mv55.at<2>(), 154.0);
	BOOST_CHECK_EQUAL(mv55.at<3>(), 162.0);

	mv2<0,1,2,3> mv56 = std::get<5>(lhs) + std::get<6>(rhs);

	BOOST_CHECK_EQUAL(mv56.at<0>(), 109.0);
	BOOST_CHECK_EQUAL(mv56.at<1>(), 180.0);
	BOOST_CHECK_EQUAL(mv56.at<2>(), 198.0);
	BOOST_CHECK_EQUAL(mv56.at<3>(), 204.0);

	mv2<0,1,2,3> mv60 = std::get<6>(lhs) + std::get<0>(rhs);

	BOOST_CHECK_EQUAL(mv60.at<0>(), 100.0);
	...
	BOOST_CHECK_EQUAL(mv61.at<1>(), 112.0);
	BOOST_CHECK_EQUAL(mv61.at<2>(), 116.0);
	...
	BOOST_CHECK_EQUAL(mv62.at<3>(), 126.0);

	mv2<0,1,2,3> mv63 = std::get<6>(lhs) + std::get<3>(rhs);

	BOOST_CHECK_EQUAL(mv63.at<0>(), 134.0);
	BOOST_CHECK_EQUAL(mv63.at<1>(), 142.0);
	BOOST_CHECK_EQUAL(mv63.at<2>(), 146.0);
	BOOST_CHECK_EQUAL(mv63.at<3>(), 107.0);

	mv2<0,1,2,3> mv64 = std::get<6>(lhs) + std::get<4>(rhs);

	BOOST_CHECK_EQUAL(mv64.at<0>(), 156.0);
	BOOST_CHECK_EQUAL(mv64.at<1>(), 101.0);
	BOOST_CHECK_EQUAL(mv64.at<2>(), 103.0);
	BOOST_CHECK_EQUAL(mv64.at<3>(), 168.0);

	mv2<0,1,2,3> mv65 = std::get<6>(lhs) + std::get<5>(rhs);

	BOOST_CHECK_EQUAL(mv65.at<0>(), 97.0);
	BOOST_CHECK_EQUAL(mv65.at<1>(), 180.0);
	BOOST_CHECK_EQUAL(mv65.at<2>(), 186.0);
	BOOST_CHECK_EQUAL(mv65.at<3>(), 196.0);

	mv2<0,1,2,3> mv66 = std::get<6>(lhs) + std::get<6>(rhs);

	BOOST_CHECK_EQUAL(mv66.at<0>(), 206.0);
	BOOST_CHECK_EQUAL(mv66.at<1>(), 214.0);
	BOOST_CHECK_EQUAL(mv66.at<2>(), 230.0);
	BOOST_CHECK_EQUAL(mv66.at<3>(), 238.0);
}
