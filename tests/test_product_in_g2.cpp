...
BOOST_AUTO_TEST_CASE(product)
{
	...
	mv2<0,1,2,3> mv15 = std::get<1>(lhs) * std::get<5>(rhs);
	...
	mv2<1,2> mv21 = std::get<2>(lhs) * std::get<1>(rhs);

	BOOST_CHECK_EQUAL(mv21.at<1>(), 221.0);
	BOOST_CHECK_EQUAL(mv21.at<2>(), -187.0);

	mv2<0> mv22 = std::get<2>(lhs) * std::get<2>(rhs);

	BOOST_CHECK_EQUAL(mv22.at<0>(), -323.0);

	mv2<1,2,3> mv23 = std::get<2>(lhs) * std::get<3>(rhs);
	...
	mv2<0,1,2> mv25 = std::get<2>(lhs) * std::get<5>(rhs);
	...
	mv2<0,1,2,3> mv31 = std::get<3>(lhs) * std::get<1>(rhs);
	...
	mv2<1,2,3> mv32 = std::get<3>(lhs) * std::get<2>(rhs);
	...
	mv2<0,1,2,3> mv51 = std::get<5>(lhs) * std::get<1>(rhs);
	...
	mv2<0,1,2> mv52 = std::get<5>(lhs) * std::get<2>(rhs);
	...
	mv2<0,1,2,3> mv55 = std::get<5>(lhs) * std::get<5>(rhs);
